...
('/exportaciones', 'Exportaciones', 'Exportar datos a archivos TXT y DBF', 'ArrowDownTrayIcon', 'Exportar', 4),
('/promociones', 'Promociones', 'Gestión de promociones', 'TagIcon', 'Ventas', 5),
('/bonificaciones', 'Bonificaciones', 'Gestión de bonificaciones', 'GiftIcon', 'Ventas', 6),
('/saldos', 'Saldos', 'Consulta de saldos', 'ArchiveBoxIcon', 'Finanzas', 7),
('/movimientos', 'Movimientos', 'Consulta de movimientos', 'ArrowDownTrayIcon', 'Finanzas', 8),
('/clientes', 'Clientes', 'Gestión de clientes', 'UserGroupIcon', 'Clientes', 9),
('/clie-vend', 'Clie_Vend', 'Relación clientes-vendedores', 'UserGroupIcon', 'Clientes', 10),
('/pedidos', 'Pedidos', 'Gestión de pedidos', 'ShoppingCartIcon', 'Ventas', 11),
('/usersbot', 'Usuarios Bot', 'Gestión de usuarios del bot', 'UserGroupIcon', 'Administración', 12),
('/gestion-usuarios', 'Gestión Usuarios', 'Administración de usuarios del sistema', 'UserGroupIcon', 'Administración', 13),
('/escalas', 'Escalas', 'Gestión de escalas', 'ChartBarIcon', 'Ventas', 14),
('/kardex-tabla', 'Kardex', 'Consulta de kardex', 'TableCellsIcon', 'Inventario', 15),
('/guias', 'Guías', 'Gestión de guías', 'TruckIcon', 'Logística', 16),
('/multi-accion', 'Multi Acción', 'Acciones múltiples', 'Bars3Icon', 'Herramientas', 17),
('/consulta-productos', 'Consulta Productos', 'Búsqueda de productos', 'MagnifyingGlassIcon', 'Inventario', 18),
('/devolucion-canje', 'Devolución Canje', 'Gestión de devoluciones', 'ArrowDownTrayIcon', 'Ventas', 19),
('/reporte-codpro', 'Reporte CodPro', 'Reporte de códigos de productos', 'DocumentTextIcon', 'Reportes', 20),
('/reportes/picking-procter', 'Picking Procter', 'Reporte de picking Procter', 'DocumentTextIcon', 'Reportes', 21),
('/reportes/concurso', 'Concurso', 'Reporte de concurso', 'DocumentTextIcon', 'Reportes', 22),
('/reportes/loreal-notas', 'Notas Loreal', 'Reporte de notas Loreal', 'DocumentTextIcon', 'Reportes', 23),
('/reportes/compras-laboratorio', 'Compras por Laboratorio', 'Reporte de compras por laboratorio', 'DocumentTextIcon', 'Reportes', 24),
('/buscar-productos', 'Buscar Productos', 'Búsqueda avanzada de productos por nombre, lote y código de barras', 'MagnifyingGlassIcon', 'Inventario', 25),
('/facturacion', 'Facturación Electrónica', 'Gestión de facturas electrónicas con Nubefact', 'DocumentTextIcon', 'Ventas', 26);
